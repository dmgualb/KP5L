...
//__HAL_RCC_DMA2_CLK_ENABLE(); // DMMG MOVED TO BELLOW

  #ifdef STM32F1xx
    __HAL_RCC_DMA1_CLK_ENABLE(); // DMMG ADDED
    DMAtx.Instance = DMA1_Channel1; // DMMG  CHANGED to DMA1
  #elif defined(STM32F4xx)
    __HAL_RCC_DMA2_CLK_ENABLE();  // DMMG  MOVED TO HERE
